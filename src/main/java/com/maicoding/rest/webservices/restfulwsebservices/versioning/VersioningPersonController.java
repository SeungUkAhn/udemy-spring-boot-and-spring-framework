package com.maicoding.rest.webservices.restfulwsebservices.versioning;
...
public class VersioningPersonController {
    ...
    public PersonV1 getFirstVersionOfRequestHeaders(){
        return new PersonV1("Bob Charlie");
    }

    @GetMapping(path = "/person/header", headers = "X-API-VERSION=2")
    public PersonV2 getSecondVersionOfRequestHeaders(){
        return new PersonV2(new Name("Bob", "Charlie"));
    }
